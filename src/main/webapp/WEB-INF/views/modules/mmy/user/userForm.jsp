...
<body>
	...
	<form:form id="inputForm" modelAttribute="userInfo"
		action="${ctx}/operator/user/createUser" method="post" class="form-horizontal">
		<sys:message content="${message}" />
		<div class="control-group">
			<label class="control-label">学生名称:</label>
			<div class="controls">
				<form:input id="realname" path="realname" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">登录名:</label>
			<div class="controls">
				<form:input id="loginname" path="loginname" htmlEscape="false" maxlength="50" oninput="checkLoginName(this);"/>
			&nbsp;<span id="msg"></span></div>
		</div>
		<div class="control-group">
			<label class="control-label">密码:</label>
			<div class="controls">
				<form:input id="password" path="password" htmlEscape="false" maxlength="50" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">手机:</label>
			<div class="controls">
				<form:input id="phonenum" path="phonenum" htmlEscape="false" maxlength="50" />
			</div>
		</div>
			<div class="control-group">
